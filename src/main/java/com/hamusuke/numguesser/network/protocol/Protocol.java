...
public enum Protocol {
    ...
    PLAY(2, protocol()
            .addDirection(PacketDirection.CLIENTBOUND, new PacketSet<ClientPlayPacketListener>()
                    ...
                    .add(TossOrAttackSelectionNotify.class, TossOrAttackSelectionNotify::new)
                    .add(TossReq.class, TossReq::new)
                    .add(TossNotify.class, TossNotify::new)
